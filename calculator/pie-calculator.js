...
function pieCalculator() {
	...
	if (form1040line1 == true) {
		filingStatus = "Single";
		StandardDeduction = 12000;
	}
	else if (form1040line2 == true) {
		filingStatus = "MFJ";
		StandardDeduction = 24000;
	}
	else if (form1040line3 == true) {
		filingStatus = "MFS";
		StandardDeduction = 24000;
	}
	else if (form1040line4 == true) {
		filingStatus = "HoH";
		StandardDeduction = 18000;
	}
	else if (form1040line5 == true) {
		filingStatus = "QW";
		StandardDeduction = 12000;
	}
	else {
	...
	var form1040line7 = document.getElementById("form1040line7").value || "0"; // Wages
	var form1040line9 = document.getElementById("form1040line9").value || "0"; // Diviends
	var form1040line12 = document.getElementById("form1040line12").value || "0"; // Self-Employment
	var form1040line13 = document.getElementById("form1040line13").value || "0"; // Capital Gains
	var form1040line17 = document.getElementById("form1040line17").value || "0"; // Rental, Partnership, and S-Corporation Income
	var form1040AllOtherIncome = document.getElementById("form1040AllOtherIncome").value || "0"; // All Other Income

	// Add Total Income from user input
	var form1040line22 = parseFloat(form1040line7) + parseFloat(form1040line9) + parseFloat(form1040line12) + parseFloat(form1040line13) + parseFloat(form1040line17) + parseFloat(form1040AllOtherIncome);
	...
	// Output User Content
	$('#total_income').html('$'+ form1040line22);
	$('#total_deduction').html('$' + form1040line40);
	$('#taxable_income').html('$' + form1040line43);
	$('#tax').html('$' + form1040line44);
